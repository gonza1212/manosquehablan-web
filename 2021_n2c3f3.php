...
<?php  
  if(isset($_POST['enviar'])) {
    if($_POST['password'] == $pass2021n2c3f3[0]) {
        echo '<div class="container">
        <div class="row justify-content-center">
          <div class="col-md-8">
            <h3>2021 - Nivel II - Clase 3 Fragmento 2</h3> 
            <iframe width="100%" height="360" src="https://www.youtube.com/embed/kb_MqxxZHPA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
          </div>
        </div>
      </div>';
      } else {
        echo '<div class="container">
                <div class="row justify-content-center mb-5">
                    <div class="col-md-8 text-center">
                        ...
                        <a href="2021_n2c3f3.php" class="btn btn-primary-lsa">Reintentar</a>
                    </div>
                </div>
            </div>';
      }
        ...
        echo '<div class="container">
                <div class="row justify-content-center">
                    <form class="col-md-6" action="2021_n2c3f3.php" method="post">
