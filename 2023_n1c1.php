...
<div class="container">
    <div class="row">
        <div class="col-md-12 text-center my-5">
            <h1 class="text-instituto">Nivel 1: Clase 1</h1>
        </div>
    </div>
</div>
...
<?php  
  if(isset($_POST['enviar'])) {
    if($_POST['password'] == $pass2023n1c1[0]) {
        ...
        echo '<div class="container">
                <div class="row justify-content-center mb-5">
                    <div class="col-md-8 text-center">
                        ...
                        <a href="2023_n1c1.php" class="btn btn-primary-lsa">Reintentar</a>
                    </div>
                </div>
            </div>';
      }
        ...
        echo '<div class="container">
                <div class="row justify-content-center">
                    <form class="col-md-6" action="2023_n1c1.php" method="post">
