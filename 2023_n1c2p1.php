...
<div class="container">
    <div class="row">
        <div class="col-md-12 text-center my-5">
            <h1 class="text-instituto">Nivel 1: Clase 2 Parte 1</h1>
        </div>
    </div>
</div>
...
<?php  
  if(isset($_POST['enviar'])) {
    if($_POST['password'] == $pass2023n1c2p1[0]) {
        ...
        <div class="row justify-content-center">
          ...
          <video width="100%" height="auto" controls class="mb-5">
              <source src="./media/interpretaciones/2023/asincronico_2_1.MOV" type="video/mp4">
          </video>
            <br>
          </div>
        </div>
        ...
        echo '<div class="container">
                <div class="row justify-content-center mb-5">
                    <div class="col-md-8 text-center">
                        ...
                        <a href="2023_n1c2p1.php" class="btn btn-primary-lsa">Reintentar</a>
                    </div>
                </div>
            </div>';
      }
        ...
        echo '<div class="container">
                <div class="row justify-content-center">
                    <form class="col-md-6" action="2023_n1c2p1.php" method="post">
