...
<?php  
  if(isset($_POST['enviar'])) {
    if($_POST['password'] == $pass2[0]) {
        ...
        <div class="row justify-content-center">
          <div class="col-md-8 text-center">
            ...
            <video width="100%" height="auto" controls class="mb-5">
                <source src="./media/interpretaciones/verano/clase_verano_2_1.MOV" type="video/mp4">
            </video>
            <br>
            <h4>Módulo 2</h4>
            <br>
            <video width="100%" height="auto" controls class="mb-5">
                <source src="./media/interpretaciones/verano/clase_verano_2_2.MOV" type="video/mp4">
            </video>
            <br>
            <h4>Módulo 3</h4>
            <br>
            <video width="100%" height="auto" controls class="mb-5">
                <source src="./media/interpretaciones/verano/clase_verano_2_3.MOV" type="video/mp4">
            </video>
            <br>
          </div>
        </div>
        ...
        echo '<div class="container">
                <div class="row justify-content-center mb-5">
                    <div class="col-md-8 text-center">
                        ...
                        <a href="clase_verano_2.php" class="btn btn-primary-lsa">Reintentar</a>
                    </div>
                </div>
            </div>';
      }
        ...
        echo '<div class="container">
                <div class="row justify-content-center">
                    <form class="col-md-6" action="clase_verano_2.php" method="post">
