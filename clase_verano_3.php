...
<?php  
  if(isset($_POST['enviar'])) {
    if($_POST['password'] == $pass3[0]) {
        ...
        <div class="row justify-content-center">
          <div class="col-md-8 text-center">
            ...
            <video width="100%" height="auto" controls class="mb-5">
                <source src="./media/interpretaciones/verano/clase_verano_3.MOV" type="video/mp4">
            </video>
            <br>
          </div>
        </div>
        ...
        echo '<div class="container">
                <div class="row justify-content-center mb-5">
                    <div class="col-md-8 text-center">
                        ...
                        <a href="clase_verano_3.php" class="btn btn-primary-lsa">Reintentar</a>
                    </div>
                </div>
            </div>';
      }
        ...
        echo '<div class="container">
                <div class="row justify-content-center">
                    <form class="col-md-6" action="clase_verano_3.php" method="post">
