...
<div class="container">
    <div class="row">
        <div class="col-md-12 text-center my-5">
            <h1 class="text-instituto">Nuestros Comienzos</h1>
        </div>
        <div class="col-md-12 mb-5">
            <p class="fs-4">Aunque hoy nuestras clases son exclusivamente virtuales, en nuestros inicios eran presenciales. ¡Conocé a quiénes se graduaron con nosotros!</p>
        </div>
    </div>
</div>
